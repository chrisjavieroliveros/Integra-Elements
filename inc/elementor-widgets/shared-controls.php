...
trait Common_Background_Color {
    ...
    protected function add_common_background_color($selector, $control_name = 'background_color', $label = 'Background Color', $default = '') {
        ...
        $color_options = ['default' => __('Default', 'integra-elements')];
        
        // Add theme colors to options
        foreach ($theme_colors as $color_name => $color_value) {
            $color_options[$color_value] = $color_name;
        }
