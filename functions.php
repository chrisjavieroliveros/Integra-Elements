...
function integra_elements_setup() {
	...
	register_nav_menus(
		array(
			'menu-1' => esc_html__( 'Primary', 'integra-elements' ),
		)
	);
...
function integra_elements_scripts() {
	...
	wp_enqueue_script( 'integra-elements-navigation', get_template_directory_uri() . '/assets/js/navigation.js', array(), _S_VERSION, true );
